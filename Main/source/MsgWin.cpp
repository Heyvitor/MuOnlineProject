...
void CMsgWin::PopUp(int nMsgCode, char* pszMsg)
{
	...
	case CREATE_ACCOUNT_FAIL_ERROR1:
		lpszMsg = "Digite o login que deseja.";
		break;
	case CREATE_ACCOUNT_FAIL_ERROR2:
		lpszMsg = "Seu login deve ter 4 ou mais caracteres";
		break;
	case CREATE_ACCOUNT_FAIL_ERROR3:
		lpszMsg = "Digite a senha que deseja.";
		break;
	case CREATE_ACCOUNT_FAIL_ERROR4:
		lpszMsg = "Digite o seu e-mail (prefer�ncia use um e-mail v�lido).";
		break;
	case CREATE_ACCOUNT_FAIL_ERROR5:
		lpszMsg = "Digite o seu PersonalID (max: 7 digitos).";
		break;
	case CREATE_ACCOUNT_FAIL_ERROR6:
		lpszMsg = pszMsg;
		break;
	case CREATE_ACCOUNT_FAIL_ERROR7:
		lpszMsg = pszMsg;
		break;
	case CREATE_ACCOUNT:
		lpszMsg = pszMsg;
