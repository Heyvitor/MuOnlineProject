...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_STORAGE_BTN_LEFT = 33028,
			IMAGE_STORAGE_BTN_RIGHT = 33029,
			IMAGE_STORAGE_BTN_CHANGE = 931317,
			IMAGE_STORAGE_BTN_BUY = 31302,

			IMAGE_STORAGE_MONEY = CNewUIMyInventory::IMAGE_INVENTORY_MONEY,
		};
